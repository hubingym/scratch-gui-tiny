...
CostumeTab.defaultProps = {
  ...
  onNewCostumeFromCameraClick: () => {
    console.log('onNewCostumeFromCameraClick');
    state.modals.openCameraCapture();
  },
  onRequestCloseCameraModal: () => {
    state.modals.closeCameraCapture();
  },
...
export default injectIntl(CostumeTabState);
