...
const dispatchProps = {
    ...
    onNewSoundFromLibraryClick: e => {
        e.preventDefault();
        state.modals.openSoundLibrary();
    },
    onNewSoundFromRecordingClick: () => {
      state.modals.openSoundRecorder();
    },
    onRequestCloseSoundLibrary: () => {
      state.modals.closeSoundLibrary();
    },
    dispatchUpdateRestore: restoreState => {
      state.restoreDeletion.setRestore(restoreState);
    },
    onCloseImporting: () => state.alerts.closeAlertWithId('importingAsset'),
    onShowImporting: () => state.alerts.showStandardAlert('importingAsset'),
};

const SoundTabState = (props) => {
...
export default injectIntl(SoundTabState);
